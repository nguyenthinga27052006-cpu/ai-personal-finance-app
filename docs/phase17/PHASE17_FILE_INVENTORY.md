...
| `scripts/backup-restore-drill.ps1` | Backup | pg_dump/pg_restore procedure and validation hooks | NOT VERIFIED |
| `apps/api/tests/test_phase17_operability.py` | Tests | Two focused observability and AI budget tests | LOCALLY VERIFIED |
...
| `docs/phase17/BACKUP_DR.md` | Backup | Backup and disaster recovery policy | LOCALLY VERIFIED |
| `docs/phase17/RESTORE_DRILL.md` | Backup | Restore drill procedure | LOCALLY VERIFIED |
| `docs/phase17/RPO_RTO.md` | Backup | RPO/RTO targets and measurement guidance | LOCALLY VERIFIED |
